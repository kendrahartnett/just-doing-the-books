...
## Grading rubric
1. **Build skill** — it works and does what the spec says.
2. **Control under constraints** (the big one) — stayed in scope, can explain every part, logged prompts, caught a mistake.
3. **Demo & communication** — clear 2-minute demo, handles two follow-up questions.
4. **Meets-the-spec** — headline, three sections, one call to action.

## Milestones
- Today: scope the project (pick the purpose, headline, three sections, the one CTA).
- Day 4: build.
- Day 5: demo-ready.
...
**Headline:** Local Bookkeeping You Can Trust
**One-sentence description:** Personal and small business bookkeeping, tax prep, and e-filing by Joanna Plues, serving local businesses and neighbors of Payson, AZ (worded/refined a few times during the Replit build — see prompt log).

**Section 1 — Services:** Personal and small business bookkeeping. Bank statement organization and review, profit & loss reports, cash flow tracking, tax services and reports, account preparation, general bookkeeping and financial record organization.

**Section 2 — About Just Doing the Books:** Joanna Plues started the business in 2012 and has been helping neighbors and local businesses keep their books ever since. Holds a Bookkeeping Certification (Eastern Arizona College) plus two Associate degrees (Business Science; Administrative Information Services). Treats every client's bookkeeping needs with the same care she'd give her own.

**Section 3 — How to Reach Her (Contact / CTA):**
- Primary CTA: email button → justdoingthebooks@gmail.com, labeled "Email Joanna Right now" (the ONE call-to-action per spec)
- Text beneath: call/text (928) 970-2835, responds within 24 hours
...
**2. Wrong content moved.** Asked to move just the PTIN circle to the bottom of the page, the AI moved the entire About section instead. Kendra caught it and corrected it (verbatim item 17).

**3. Extra files in the exported package.** The AI's downloadable file package included more than the required HTML/CSS/JS three files. Kendra caught it and required an HTML/CSS/JS-only package (Replit session summary, item 7-S.14).

## Key takeaway
This isn't a "make AI build a website" exercise — it's a "direct AI and stay accountable for the result" exercise. Every constraint (scope, explain, log, catch-a-mistake) exists to force ownership over the output rather than passive acceptance of whatever the AI produces.